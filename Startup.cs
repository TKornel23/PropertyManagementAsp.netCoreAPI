...
namespace PropertyManagement
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<PropertyDbContext>(options => options.UseSqlServer("Data Source=localhost;Initial Catalog=PropertyManagementSite;Integrated Security=True"));
